...
Make a word *italic*, or _a whole phrase_.
Make a word **bold**, or __a whole phrase__.
Get creative and **combine _emphasis_**.
Strikethrough is also ~~not~~ possible.
...
- Unordered lists are easy to make
- Just start a line with a `-`, `+`, or `*`!
+ you can mix and match too
* but you should probably stick to one style
    - sublists
    - just use
    - indents


1. Ordered lists are created like this
1. Notice that the value doesn't matter
1. As long as it is a digit!
    1. you can make sublists using indents
    1. the same rules apply
3. one more thing:
    - you can make unordered sublists
    - inside of ordered lists
    - and vice-versa!
...
![James Quick](./IMG_20230411_163042603_HDR.jpg)

left or right alignment of images

<img align="left" width="100" height="100" src="./IMG_20230411_163042603_HDR.jpg">     
centre alignment 


<p align="center">
  <img width="400" height="300" src="./IMG_20230411_163042603_HDR.jpg">
</p>
...
You can make tables render nicely:

| header1 | header2    | header3 | header4 |
| ------- |:-------    |:-------:| -------:|
|  entry  |  **entry** |  entry  |  entry  |
|  entry  |  _entry_   |  entry  |  entry  |
|  entry  |  `entry`   |  entry  |  entry  |

The colons let you change text alignment in columns. The dashes divide the header row
from the regular rows, and the `|` character separates columns. SkyLab offers a built-in
Markdown table generator in the text editor for Markdown files so you don't have to
type it out yourself!

You also don't need to align the `|` characters or use that many dashes; the following example table
demonstrates the minimum required to generate a table:
